  ...
  return (
    <Row className="mobile-navbar">
      <Col xs={6}>
        <Row>
          <Col
            onClick={() => props.handleNavButtonClick(1)}
            href="#"
            xs={6}
          ...
          <Col
            onClick={() => props.handleNavButtonClick(2)}
            href="#"
            xs={6}
            className="mobile-item"
          >
      ...
      <Col xs={6}>
        <Row>
          <Col
            onClick={() => props.handleNavButtonClick(3)}
            href="#"
            xs={6}
            className="mobile-item"
          >
          ...
          <Col
            onClick={() => props.handleNavButtonClick(4)}
            href="#"
            xs={6}
            className="mobile-item"
          >
  ...
  constructor(props) {
    ...
    users.on("value", data => {
      ...
      data.forEach(child => {
        ...
        if (child.val().uid === currUser.uid) groupID = child.val().groupID;
      });
      if (groupID === null) {
